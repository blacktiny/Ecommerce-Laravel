                                        ...
                                        <div class="form-inline product-box">
                                            <div class="form-group Qty" @if(!empty($result['detail']['product_data'][0]->flash_start_date) and $result['detail']['product_data'][0]->server_time < $result['detail']['product_data'][0]->flash_start_date ) style="display: none" @endif>
                                                ...
                                                <div class="input-group">						
                                                    ...
                                                    <input type="text" readonly name="quantity" value="@if($result['detail']['product_data'][0]->products_min_order>0) {{$result['detail']['product_data'][0]->products_min_order}} @else 1 @endif" min="@if($result['detail']['product_data'][0]->products_min_order>0) {{$result['detail']['product_data'][0]->products_min_order}} @else 1 @endif" max="@if(!empty($result['detail']['product_data'][0]->products_max_stock) and $result['detail']['product_data'][0]->products_max_stock>0){{ $result['detail']['product_data'][0]->products_max_stock}}@else{{ $result['detail']['product_data'][0]->defaultStock}}@endif" class="form-control qty">						
