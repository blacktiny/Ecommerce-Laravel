...
<section class="site-content">
  <div class="container"> 
   ...
   <div class="products-area">
    ...
    <div class="products-area" style="padding-left: 15px; padding-right: 15px;">
      <div class="row">
        <div class="col-md-12">
          <div class="nav nav-pills" role="tablist">
          ...
          <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane fade show active" id="featured" role="tabpanel" aria-labelledby="featured-tab">
                @if($result['top_seller']['product_data'])
