		...
		<div class="row">
			<div class="col-12 col-md-6 col-lg-7 new-customers">
				...
				<form name="signup" enctype="multipart/form-data" class="form-validate" action="{{ URL::to('/signupProcess')}}" method="post">
					...
					<div class="form-group row">
						<label for="staticEmail" class="col-sm-4 col-form-label"><strong>*</strong>@lang('website.Position')</label>
						<div class="col-sm-8">
							<input type="text" name="position" id="position" class="form-control field-validate" value="{{ old('position') }}">
					...
					<div class="form-group row">					
						<label for="inputPassword" class="col-sm-4 col-form-label"><strong>*</strong>@lang('website.Website')</label>
						<div class="col-sm-8">
							<input type="text" name="website" id="website" class="form-control field-validate"  value="{{ old('website') }}">
							<span class="help-block error-content" hidden>@lang('website.Please enter your website')</span>
						</div>
					</div>

					<div class="form-group row">
						<label for="inputPassword" class="col-sm-4 col-form-label"><strong>*</strong>@lang('website.Company phone')</label>
						<div class="col-sm-8">
							<input type="text" name="companyPhone" id="companyPhone" class="form-control field-validate"  value="{{ old('companyPhone') }}" onkeypress="return isNumberKey(event)">
					...
					<div class="form-group row">
						<label for="inlineFormCustomSelect" class="col-sm-4 col-form-label"><strong>*</strong>@lang('website.Industry')</label>
						<div class="col-sm-8">
