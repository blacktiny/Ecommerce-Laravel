...
<div class="row">
      <div class="col-md-12">
					  ...
					  <div class="modal-body">		
						  <div class="form-group">
						   ...
						   <div class="form-group">
							...
							<div class="form-group">
							  <label for="name" class="col-12 col-sm-2 col-md-4 control-label">{{ trans('labels.Price') }}</label>
        ...
        <div class="box-footer text-center">
                ...
                <a href="{{ URL::to("admin/addinventory/{$result['data']['products_id']}")}}" class="btn btn-primary pull-right">{{ trans('labels.Add Stock') }} <i class="fa fa-angle-right"></i> </a>
		</div>
