                         ...
                         <div class="box-body">
                            {!! Form::open(array('url' =>'admin/addnewcustomers', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    {!! Form::text('customers_position',  '', array('class'=>'form-control field-validate', 'id'=>'customers_position')) !!}
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    {!! Form::text('website',  '', array('class'=>'form-control field-validate', 'id'=>'website')) !!}
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    {!! Form::text('company_phone',  '', array('class'=>'form-control field-validate', 'id'=>'company_phone', 'onkeypress'=>'return isNumberKey(event)')) !!}
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    {!! Form::text('customers_cellphone',  '', array('class'=>'form-control field-validate', 'id'=>'customers_cellphone', 'onkeypress'=>'return isNumberKey(event)')) !!}
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    <select class="form-control" name="industry_type" id="industryTypeSelect">
                                    </select>
                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                ...
                                <div class="form-group">
                                  ...
                                  <div id="machine-section" class="col-sm-10 col-md-4">
                                    <div class="col-sm-12" style="padding: 0; margin-bottom: 25px;">
                                      {!! Form::text('machineModel[]',  '', array('class'=>'form-control field-validate', 'id'=>'machineModel', 'style'=>'display: inline; width: calc(100% - 35px);')) !!}
...
<script type="text/javascript">
	...
	$(function () {
		...
		// $industryType.empty();
		@foreach($customers['industryTypes'] as $type)
